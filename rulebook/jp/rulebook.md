...
本制度における脆弱性報告に関するお問い合わせは、報告用サイトにて受け付けます。  
報告用サイト： 
...
### 製品・サービス
||kintone(\*1)<br>cybozu.com 共通管理(\*1)<br>kintone アプリストア|Garoon(\*1)<br>メールワイズ<br>Office
|:--|:--|:--|
|RCE|200万円(固定)|200万円(固定)|
...
## 6.3	報奨金の受け渡しについて
対応プロセスがすべて完了(※)した時点から、翌々月末までに報奨金をお振込みいたします。  
報告者は Cy-PSIRT に対し受取先の口座情報をご連絡いただく必要があります。  
指定可能な受取先の口座情報については、「脆弱性報奨金制度規約(第3条)」をご確認ください。

以下の場合には、お支払いの手続きに時間を要する、またはお支払いができないことがあります。  
- 受取先の口座情報をご連絡いただけない  
- ご連絡いただいた受取先の口座情報に基づいて弊社が送金手続きを行ったにもかかわらず、報告者が報奨金を受領できなかった

なお、海外送金の場合は、弊社で送金手続きが完了していても、中継銀行の経由や送金先の国・金融機関などの事情により、受取先の口座への入金までに数日から1週間以上を要することがあります。

※ 対応プロセスの完了についての詳細はこちらをご参照ください。  
https://github.com/cybozu/bugbounty/blob/master/rulebook/jp/rulebook.md#51-対応プロセス
